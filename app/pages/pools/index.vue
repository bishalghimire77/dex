    ...
    const versionMatch =
      ...
      pool.items?.some(
        item =>
          item.version
            .toUpperCase()
            .includes(selectedVersion.value)
      )

    /* TOKEN */
    const tokenMatch =
      selectedToken.value === 'All' ||
      pool.name.includes(selectedToken.value)
...
<template>
  <div class="min-h-screen text-white overflow-hidden">
    ...
    <div class="border-b border-white/5 bg-[#0f1725]/90 backdrop-blur-xl">
      <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
        ...
        <div class="flex gap-8 text-lg">
          <button class="text-white border-b-2 border-cyan-400 pb-2 font-semibold">
            Pools
          </button>
    ...
    <!-- HELP SECTION -->
    <div class="bg-gradient-to-r from-cyan-500/20 to-white/10 border-b border-white/5">
      <div class="max-w-7xl mx-auto px-6 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <div class="inline-flex px-3 py-1 rounded-full border border-white/20 text-xs text-gray-300">
              3min
            </div>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-6 py-10">
      ...
      <div class="grid grid-cols-2 gap-20 mb-14 max-w-3xl">
        ...
        <div>
          ...
          <div class="text-pink-500 text-sm font-semibold mt-2">
            ↓ -2.17%
          </div>
        </div>
